                ...
                <form method="POST" action="validation.php">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="fullname" name="admin_name" placeholder="John Doe" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" id="email" name="admin_email" placeholder="username@domain.com" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" id="password" name="admin_password" placeholder="••••••••••••" required>
                        </div>
                    </div>
