    ...
    <nav class="navbar navbar-dark fixed-top py-3 shadow-sm">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center gap-3">
                <input class="form-control rounded-pill" type="search" placeholder="Search products..." style="width: 260px;">
                ...
                <table class="table table-hover mb-0" id="productsTable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Electronics</td>
                            <td>$89.99</td>
                            <td><span class="badge bg-success">124</span></td>
                            <td><span class="badge bg-success">In Stock</span></td>
                            <td class="text-nowrap">
                                <div class="d-flex gap-2 flex-wrap">
                                    <button class="btn btn-sm btn-outline-primary" onclick="editProduct(1)">Edit</button>
                                    <button class="btn btn-sm btn-outline-danger" onclick="deleteProduct(1)">Delete</button>
                                </div>
                            </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="prodPrice" placeholder="0.00">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Stock Quantity</label>
                        <input type="number" class="form-control" id="prodStock" placeholder="0">
                    </div>
                </div>
